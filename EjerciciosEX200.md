...
<details>
	<summary> 1.- Configure an identity provider<br><br>
	  &emsp;&emsp;Configure your OpenShift cluster to use an HTPasswd identity provider with the following requirements:<br>
			<pre>	
			- The name of the identity provider is: ex280-htpasswd<br>
			- The name of the secret is: ex280-idp-secret<br>
			- The user account armstrong=indionce<br>
			- The user account collins=veraster<br>
			- The user account aldrin=roonkere<br>
			- The user account jobs=sestiver<br>
			- The user account wozniak=glegunge<br>
			</pre>
	</summary>
